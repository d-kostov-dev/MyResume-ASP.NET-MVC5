namespace MyResume.Web.Areas.Administration.Controllers
{
    ...
    using InputModel = MyResume.Web.Areas.Administration.Models.InputModels.AddEditCertificationInputModel;
    using ViewModel = MyResume.Web.Areas.Administration.Models.ViewModels.CertificationViewModel;

    public class CertificationsController : AdminBaseController
    {
        private ICertificationsService dataProvider;
