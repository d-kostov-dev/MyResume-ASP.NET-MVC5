namespace MyResume.Web.Areas.Administration.Controllers
{
    ...
    using InputModel = MyResume.Web.Areas.Administration.Models.InputModels.AddEditSkillInputModel;
    using ViewModel = MyResume.Web.Areas.Administration.Models.ViewModels.SkillViewModel;
    
    public class SkillsController : AdminBaseController
    {
        private ISkillsService dataProvider;

        public SkillsController(ISkillsService servicesProvider)
