namespace MyResume.Web.Areas.Administration.Controllers
{
    ...
    using InputModel = MyResume.Web.Areas.Administration.Models.InputModels.AddEditProjectInputModel;
    using ViewModel = MyResume.Web.Areas.Administration.Models.ViewModels.ProjectViewModel;

    public class ProjectsController : AdminBaseController
    {
        private IProjectsService dataProvider;

        public ProjectsController(IProjectsService servicesProvider)
