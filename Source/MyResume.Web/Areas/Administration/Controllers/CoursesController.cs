namespace MyResume.Web.Areas.Administration.Controllers
{
    ...
    using InputModel = MyResume.Web.Areas.Administration.Models.InputModels.AddEditCourseInputModel;
    using ViewModel = MyResume.Web.Areas.Administration.Models.ViewModels.CourseViewModel;

    public class CoursesController : AdminBaseController
    {
        private ICoursesService dataProvider;

        public CoursesController(ICoursesService servicesProvider)
