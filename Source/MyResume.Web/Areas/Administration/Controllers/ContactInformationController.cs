namespace MyResume.Web.Areas.Administration.Controllers
{
    ...
    using InputModel = MyResume.Web.Areas.Administration.Models.InputModels.AddEditContactInformationInputModel;
    using ViewModel = MyResume.Web.Areas.Administration.Models.ViewModels.ContactInformationViewModel;

    public class ContactInformationController : AdminBaseController
    {
        private IContactInformationService dataProvider;
